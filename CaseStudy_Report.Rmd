...
In this section, we would use some dicretion in plotting our graph, there are about 189 countries in our dataset. It will not be efficient to plot all countries on the X axis therefore we group the countries by income group and plot against GDP.     
```{r echo=FALSE}
