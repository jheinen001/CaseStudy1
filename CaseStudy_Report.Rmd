...
This data projects seeks to explore world world economic and
...
Given the output, we see that the average GDP rankings for the  the High income: nonOECD countries is 91.91304 and  32.96667  for  High income: OECD countries respectively
```{r}
...
In this section, we would use some dicretion in plotting our graph, there are about 189 countries in our dataset. t will be efficient to plot all countries on the X axis therefore we group group the countries by income group and plot against GDP.     
```{r echo=FALSE}
